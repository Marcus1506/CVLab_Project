...
if __name__ == "__main__":
    ...
    CVLab.utils.std_training_loop_tuple(
        model, train_data=dataset_train, val_data=dataset_eval, num_epochs=20, model_name="guided_transfer_batch8_leaky_full_extensive_finetuned128_MSESSIM_0.5_0.25_bettermonitored",
